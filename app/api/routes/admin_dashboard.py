...
def render_appointments_table(appointments: List[Any]) -> str:
    ...
    for appt in appointments:
        ...
        <tr>
            ...
            <td>
                <span class="badge {status_class}">{status.title()}</span>
            </td>
            <td>
            ...
            <td>
                <div class="btn-group btn-group-sm">
                    <button class="btn btn-outline-primary" onclick="updateAppointmentStatus({appt.id}, 'confirmed')">
                        <i class="bi bi-check"></i>
                    </button>
                    <button class="btn btn-outline-warning" onclick="updateAppointmentStatus({appt.id}, 'completed')">
                        <i class="bi bi-check2-all"></i>
                    </button>
                    <button class="btn btn-outline-danger" onclick="deleteAppointment({appt.id})">
